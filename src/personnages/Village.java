...
public class Village {
	...
	public void afficherVillageois(Village village) {
		System.out.println("Dans "+village.getnom()+" du chef "+village.getchef()+ " vivent les l�gendaires gaulois: ");
...
//		Exception car liste va de 0 � 29 donc out of bounds
...
//		resultat obtenu est null car asterix est tri� � l'indice 0 du tableau et non pas 1
